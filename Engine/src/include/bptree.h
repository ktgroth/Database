...
void print_btree_node(const bptree_node_t *node, type_e type);
...
int btree_add(bptree_t *tree, const void *key, datablock_t *block);
...
int btree_update_key(bptree_t *tree, const void *key, size_t colidx, void *value);
int btree_update(bptree_t *tree, const char *keycol, const void *keyval, const char *colname, void *value);
